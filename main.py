...
# --- 💎 DIAMOND LIST DATA (အစဉ်လိုက်ဖြစ်အောင် စီထားသည်) ---
GAMES_DATA = [
    {
        "name": "Normal Server",
        "img": "https://img.icons8.com/color/144/mobile-legends.png",
        "cats": {
            "Normal Dia": [{"d": "11", "p": "700"}, {"d": "22", "p": "1400"}, {"d": "33", "p": "2100"}, {"d": "44", "p": "2800"}, {"d": "56", "p": "3500"}, {"d": "112", "p": "7000"}, {"d": "257", "p": "13800"}, {"d": "343", "p": "18600"}, {"d": "600", "p": "32650"}, {"d": "1412", "p": "74900"}],
    ...
    },
    {
        ...
        "cats": {
            "Normal Dia": [{"d": "5", "p": "450"}, {"d": "12", "p": "950"}, {"d": "28", "p": "2200"}, {"d": "85", "p": "5850"}, {"d": "170", "p": "11700"}, {"d": "296", "p": "20500"}, {"d": "875", "p": "58500"}, {"d": "2010", "p": "123500"}],
            "Weekly Pass": [{"d": f"Weekly Pass {i}X", "p": str(7500 * i)} for i in range(1, 6)],
            "2X Dia": [{"d": "10+10 💎", "p": "800"}, {"d": "100+100 💎", "p": "7000"}],
    ...
    },
    {
        ...
        "cats": {
            "Normal Dia": [{"d": "14", "p": "1050"}, {"d": "42", "p": "3100"}, {"d": "70", "p": "5050"}, {"d": "140", "p": "10100"}, {"d": "355", "p": "25200"}, {"d": "716", "p": "50200"}],
    ...
    },
    {
        ...
        "cats": {
            "Normal Dia": [{"d": "11", "p": "750"}, {"d": "22", "p": "1500"}, {"d": "56", "p": "3500"}, {"d": "112", "p": "7000"}, {"d": "336", "p": "21300"}, {"d": "1163", "p": "70500"}],
            "Weekly Pass": [{"d": f"Weekly Pass {i}X", "p": str(6500 * i)} for i in range(1, 6)],
            "Bundle Pack": [{"d": "Weekly Elite", "p": "3200"}]
        }
    },
    {
        "name": "Russia (🇷🇺)",
        ...
        "cats": {
            "Normal Dia": [{"d": "35", "p": "2750"}, {"d": "165", "p": "13000"}, {"d": "565", "p": "44500"}, {"d": "1765", "p": "132000"}],
...
<style>
    ...
    .cat-tabs-container { overflow-x: auto; white-space: nowrap; padding: 5px 0 15px 0; }
    .cat-tab { padding:10px 15px; background:#1e293b; border-radius:10px; font-size:12px; border:1px solid #334155; display:inline-block; margin-right:5px; color:#94a3b8; }
...
@app.route('/admin')
def admin():
    if not session.get('logged_in'): return '<body style="background:#0f172a;color:white;padding:50px;"><form action="/login" method="post"><h3>Admin Login</h3><input name="pw" type="password" style="padding:10px; width:100%; border-radius:10px; background:#1e293b; color:white; border:1px solid #334155;"><button style="width:100%; padding:10px; margin-top:10px; border-radius:10px; background:#fbbf24; color:black; font-weight:bold; border:none;">Login</button></form></body>'
    orders = db.all()[::-1]
    admin_html = '''
    <body style="background:#0f172a;color:white;padding:20px;font-family:sans-serif;">
    <h2 style="color:#fbbf24;">Admin Orders <a href="/logout" style="font-size:12px;color:#ef4444;text-decoration:none;float:right;">Logout</a></h2>
    {% for o in orders %}
    <div style="background:#1e293b;padding:15px;border-radius:10px;margin-bottom:15px;border:1px solid #334155; border-left: 5px solid {% if o.status == 'Success' %}#10b981{% elif o.status == 'Cancel' %}#ef4444{% else %}#fbbf24{% endif %};">
        ...
        <div style="display:flex; gap:10px;">
            <a href="/update/{{o.id}}/Success" style="flex:1; background:#10b981; color:white; padding:10px; text-align:center; text-decoration:none; border-radius:8px; font-size:14px;">Success</a>
